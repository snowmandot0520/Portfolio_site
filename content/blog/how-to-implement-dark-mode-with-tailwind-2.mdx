...
Check out my starter template [HERE!](https://github.com/snowmandot0520/tailwindcss-v2-dark-mode-template)
...
You can clone the repo [HERE!](https://github.com/snowmandot0520/tailwindcss-v2-dark-mode-template)
